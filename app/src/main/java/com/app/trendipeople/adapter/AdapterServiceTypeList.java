 ...
 */
public class AdapterServiceTypeList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterServiceTypeList(Context context, OnCustomItemClicListener lis, ArrayList<ModelCategory> list) {
