 ...
 */
public class AdapterFreelancerCompleteBookings extends RecyclerView.Adapter<AdapterFreelancerCompleteBookings.CustomViewHolder> {

    ArrayList<ModelCategory> detail;
    Context mContext;
    OnCustomItemClicListener listener;

    public AdapterFreelancerCompleteBookings(Context context, OnCustomItemClicListener lis, ArrayList<ModelCategory> list) {
