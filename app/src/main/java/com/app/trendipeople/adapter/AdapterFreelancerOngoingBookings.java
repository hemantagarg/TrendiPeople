 ...
 */
public class AdapterFreelancerOngoingBookings extends RecyclerView.Adapter<AdapterFreelancerOngoingBookings.CustomViewHolder> {

    ArrayList<ModelCategory> detail;
    Context mContext;
    OnCustomItemClicListener listener;

    public AdapterFreelancerOngoingBookings(Context context, OnCustomItemClicListener lis, ArrayList<ModelCategory> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_freelancer_ongoing_booking, viewGroup, false);
