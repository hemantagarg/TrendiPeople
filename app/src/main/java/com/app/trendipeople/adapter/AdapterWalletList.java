...
public class AdapterWalletList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterWalletList(Context context, OnCustomItemClicListener lis, ArrayList<NotificationModel> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_walletlist, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_name.setText(m1.getSenderName());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView text_name, text_date,text_wallet_balance;
