...
import com.app.trendipeople.adapter.AdapterFreelancerCompleteBookings;
...
public class FragementVendorCompleteBooking extends Fragment implements OnCustomItemClicListener, ApiResponse {

    private RecyclerView recycler_service;
    private ArrayList<ModelCategory> imagelist;
    private AdapterFreelancerCompleteBookings adapterFreelancerCompleteBookings;
        ...
        try {
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterFreelancerCompleteBookings = new AdapterFreelancerCompleteBookings(mActivity, FragementVendorCompleteBooking.this, imagelist);
                    recycler_service.setAdapter(adapterFreelancerCompleteBookings);
