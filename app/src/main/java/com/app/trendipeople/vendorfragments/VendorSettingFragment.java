...
import com.app.trendipeople.activities.UpdatePriceListActivity;
...
public class VendorSettingFragment extends BaseFragment implements View.OnClickListener, ApiResponse {


    public static VendorSettingFragment settingFragment;
    private Activity mActivity;
    private View view;
    private final String TAG = VendorSettingFragment.class.getSimpleName();
    private RelativeLayout rl_profile,rl_time, rl_services, rl_portfolio, rl_changePassword, rl_my_booking, rl_switch_freelancer, rl_share_us, rl_rate_us, rl_logout;

    public static VendorSettingFragment getInstance() {
        if (settingFragment == null)
            settingFragment = new VendorSettingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.vendor_setting_fragment, container, false);
    ...
    private void initViews() {
        ...
        rl_portfolio = (RelativeLayout) view.findViewById(R.id.rl_portfolio);

        rl_profile.setOnClickListener(this);
        rl_portfolio.setOnClickListener(this);
    ...
    protected void setFragment(Fragment fragment) {
        VendorDashboard.getInstance().pushFragments(GlobalConstants.TAB_PROFILE_BAR, fragment, true);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_portfolio:
                ...
                FragmentVendorPortfolio vendorPortfolio = new FragmentVendorPortfolio();
                setFragment(vendorPortfolio);

                break;

            case R.id.rl_time:

                FragmentVenderDateTime fragmentVenderDateTime = new FragmentVenderDateTime();
                setFragment(fragmentVenderDateTime);

                break;

            case R.id.rl_services:

                Intent intent = new Intent(mActivity, UpdatePriceListActivity.class);
                startActivity(intent);
                break;
            case R.id.rl_my_booking:

                VendorBookingFragment userBookingFragment = new VendorBookingFragment();
